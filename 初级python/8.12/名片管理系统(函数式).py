...
#         print('退出操作')
#         break
# [12,12,234,32,32,234] [13,14,123,13,14,234] [1,1,1,1,324,23,4,32,2,2]
# def quchong(a):
#     b = []
#     for i in a:
#         if i not in b:
...
# print(quchong(a), quchong(b), quchong(c))
...
# b = [13,14,123,13,14,234]
# c = [1,1,1,1,324,23,4,32,2,2]
# print(maopaopaixu(a), maopaopaixu(b), maopaopaixu(c))
#
# def qiuhe(a, b):
#     sum = 0
